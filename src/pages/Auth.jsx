...
export default function Auth({ setSession }) {
  ...
  const handleSignIn = async (e) => {
    ...
    // ✅ update session di App agar ProtectedRoute langsung menganggap user sudah login
    ...
    <div className="modern-login-container">
      ...
      <div className="login-form-side">
        <div className="login-content-wrapper">
          ...
          <div className="brand-header mb-5 d-flex align-items-center gap-3">
            ...
            <div>
              <h3
                ...
                style={{ color: '#1a237e', letterSpacing: '-0.5px', fontSize: '1.4rem' }}
              >
                SIMRISKOM
              </h3>
          ...
          {message && (
            <div
              className={`alert alert-${message.type} d-flex align-items-center border-0 shadow-sm mb-4`}
              role="alert"
